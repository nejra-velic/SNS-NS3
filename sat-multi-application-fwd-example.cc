...
//  LogComponentEnable ("PacketSink", LOG_LEVEL_ALL);
  ...
  simulationHelper->SetBeamSet ({12,22,33,45});
  ...
  */
  ...
  s->AddAverageUtFwdAppThroughput (SatStatsHelper::OUTPUT_SCATTER_FILE);
  s->AddAverageUtFwdAppThroughput (SatStatsHelper::OUTPUT_SCATTER_PLOT);

  s->AddGlobalFwdAppThroughput (SatStatsHelper::OUTPUT_SCATTER_FILE);
  s->AddGlobalFwdAppThroughput (SatStatsHelper::OUTPUT_SCATTER_PLOT);

  s->AddGlobalFwdAppDelay (SatStatsHelper::OUTPUT_SCATTER_FILE);
  s->AddGlobalFwdAppDelay (SatStatsHelper::OUTPUT_SCATTER_PLOT);

  s->AddGlobalFwdDaPacketError (SatStatsHelper::OUTPUT_SCALAR_FILE);
